...
void AppController::launch()
{
  ...
  if (((the_ctrl == Ctrl::LAST) && (last_ctrl[0] != current_ctrl)) || (the_ctrl != current_ctrl)) {
    ...
    switch (current_ctrl) {
      ...
      case Ctrl::PARAM:   param_controller.leave(); break;
    ...
    switch (current_ctrl) {
      ...
      case Ctrl::PARAM:   param_controller.enter(); break;
...
AppController::key_event(EventMgr::KeyEvent key)
{
  ...
  switch (current_ctrl) {
    ...
    case Ctrl::PARAM:   param_controller.key_event(key); break;
...
AppController::going_to_deep_sleep()
{
  ...
  switch (current_ctrl) {
    ...
    case Ctrl::PARAM:   param_controller.leave(true); break;
